...
class TestTheNameARowKeeps:
    """Core composes from candidates and preserves identity boundaries (#290)."""
    ...
    def test_the_first_name_a_lane_composes_is_taken(self) -> None:
        ...
        registry.observe(
            ...
            seeing(
                codex_row(
                    session_id="abc", pid=10, project_name="GPT-VoiceCoding", thread_name="a task"
                )
            ),
            now=NOW,
        )
    ...
    def test_a_codex_row_that_gains_its_thread_id_is_named_for_it(self) -> None:
        ...
        registry.observe(
            ...
            seeing(
                codex_row(
                    session_id="abc", pid=10, project_name="GPT-VoiceCoding", thread_name="abc12345"
                )
            ),
            now=NOW + 5,
        )
